        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 custom-aside">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white">
                ...
                <ul class="nav nav-pills flex-column  align-items-center align-items-sm-start custom-ul" id="menu">
                    <li class="nav-item">
                        <a href="../crud/Crud.php" class="nav-link align-middle px-0 custom-icon ">
                    ...
                    <li>
                        <a href="" data-bs-toggle="collapse" class="nav-link px-0 align-middle text-white">
                            <i class="icon fs-4 bi-fork-knife custom-icon"> Platos</i> <span class="ms-1 d-none d-sm-inline text-white"></span> </a>
