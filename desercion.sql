...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-05-2025 a las 00:23:50
...
INSERT INTO `usuarios` (`cedula`, `nombre`, `apellidos`, `telefono`, `contraseña`, `rol`, `id_estado`) VALUES
(123456789, 'admin', '', '3024397300', '12345', 'administrador', 1),
(1107842584, 'Miguel', 'Pardo', '', '1234', 'cajero', 1);
...
ALTER TABLE `usuarios`
  ...
  ADD UNIQUE KEY `correo` (`telefono`),
...
ALTER TABLE `plato_ingredientes`
  ...
  ADD CONSTRAINT `plato_ingredientes_ibfk_2` FOREIGN KEY (`id_ingrediente`) REFERENCES `ingredientes` (`num_consecutivo`) ON DELETE CASCADE;
