        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 custom-aside">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white">
                ...
                <ul class="nav nav-pills flex-column  align-items-center align-items-sm-start custom-ul" id="menu">
                    <li class="nav-item">
                        <a href="../crud/Crud.php" class="nav-link align-middle px-0 custom-icon <?= esActivo('inicio') ?>">
                ...
                <div class="dropdown pb-4 ">
                    ...
                    <ul class="dropdown-menu dropdown-menu text-small shadow custom-drop">
                        <li><a class="dropdown-item custom-a" href="../confi-usuario/perfil.php"><i class="bi bi-person"></i>
                        Profile</a></li>
                        <li><a class="dropdown-item custom-a" href="../confi-usuario/configuracion.php"><i class="bi bi-gear"></i>
                        Settings</a></li>
                        <li>
