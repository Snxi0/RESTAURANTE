    ...
    //limpia los datos que tengo en secion
        ...
        <div class="card card-body bg-black">
                ...
                <!-- Button trigger modal -->
                    <button type="button" class="btn btn-custom w-100 mt-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
        ...
        <table class="table table-hover table-striped  custom-table">
            ...
            <tbody>
                ...
                while($row = mysqli_fetch_array($resultas)){?> <tr>
                    <td> <?php echo $row['num_consecutivo'] ?></td>
                    <td> <?php echo $row['nombre'] ?></td>
                    <td> <?php echo $row['descripcion'] ?></td>
                    <td> <?php echo $row['cantidad_disponible'] ?></td>
                    <td>
                        <a href="crudIngredientes/deleteingredientes.php?num_consecutivo=<?php echo $row['num_consecutivo']?>"class="btn btn-danger btn-sm">
